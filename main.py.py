...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.label = None
        self.menu_frame = CTkFrame(self, width=30, height=300, fg_color="#736e66")
        self.menu_frame.pack_propagate(False)
        self.menu_frame.place(x=0, y=0)
        self.is_show_menu = False
        self.speed_animate_menu = -20
        self.btn = CTkButton(self, text='▶', command=self.toggle_show_menu, width=30, fg_color="#736e66")
        ...
        self.send_button = CTkButton(self, text='>', width=50, height=40, command=self.send_message, fg_color="#363431")
        self.send_button.place(x=0, y=0)

        self.open_img_button = CTkButton(self, text='📁', width=50, height=40, command=self.open_image, fg_color="#363431")
        self.open_img_button.place(x=0, y=0)

        self.adaptive_ui()

        self.add_message("Демонстрація відображення зображення:",
                         CTkImage(Image.open('images.jpg'), size=(300, 300)))
    ...
    def toggle_show_menu(self):
        if self.is_show_menu:
            ...
            self.entry.pack()
            self.save_button = CTkButton(self.menu_frame, text="Зберегти", command=self.save_name, fg_color="#363431")
    ...
    def handle_line(self, line):
        ...
        if msg_type == "TEXT":
            ...
            if len(parts) >= 4:
                ...
                b64_img = parts[3]
                try:
                    img_data = base64.base64decode(b64_img)
